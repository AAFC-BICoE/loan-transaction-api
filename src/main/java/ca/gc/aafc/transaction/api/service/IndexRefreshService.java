...
public class IndexRefreshService {
  ...
  private static final String SELECT_ALL_TRANSACTION_SQL = "SELECT uuid FROM Transaction ORDER BY id";
  ...
  public IndexRefreshService(DocumentOperationNotificationMessageProducer searchRabbitMQMessageProducer,
    ...
    supportedDocumentTypes = Set.of(TransactionDto.TYPENAME);
  ...
  public void reindexAll(String type) {
    ...
    Stream<UUID> objStream =
      baseDAO.streamAllByQuery(UUID.class, SELECT_ALL_TRANSACTION_SQL, null);
